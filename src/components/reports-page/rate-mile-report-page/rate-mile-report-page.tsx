...
import {
  rateMileReportPage,
  initialRateMileReportPageState,
...
const formReducer = (
  ...
  switch (action.type) {
    ...
    case "SET_changeToOverriddenRate":
      return { ...state, new: !state.changeToOverriddenRate };
    case "SET_new":
                ...
                <Row>
                  <Col lg={12} md={12} sm={12} className="px-3">
                    <FormGroup check>
                      <Input
                        type="checkbox"
                        checked={state.changeToOverriddenRate}
                        onChange={handleCheckboxChange(
                          "SET_changeToOverriddenRate"
                        )}
                      />
                      <Label check>Change To Overridden Rate</Label>
                    </FormGroup>
                  </Col>
                </Row>
              </Col>
...
export default RateMileReportPage;
