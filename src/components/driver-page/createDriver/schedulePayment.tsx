...
const SchedulePayment = () => {
  ...
  const [driverSchedulePayeeList] = useState<IDriverSchedulePayee[]>([]);
  ...
  const handleDriverInput = (prop: keyof IDriverSchedulePayee) => (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    ...
    <div className="d-flex justify-content-end m-3">
      ...
      <ModalHeader close={closeBtn}
        ...
        <Col md={6}>
        <FormGroup>
        <Label for="application_date">Amount</Label>
       <Input bsSize="sm" className="form-control form-control-sm" type="date" id="application_date" name="application_date" value={driverSchedulePayee.amount} onChange={handleDriverInput('amount')} />
       ...
       <Row>
        ...
        <Col md={6}>
        <FormGroup>
        <Label for="application_date">Active</Label>
       <Input bsSize="sm" className="form-control form-control-sm" type="date" id="application_date" name="application_date"  />
