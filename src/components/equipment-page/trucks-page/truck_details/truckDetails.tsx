...
//import { ITruckDetails, ITruckManagementProps } from '../../../../services/tms-objects/Truck.types';
...
const TruckDetails = (prop: ITruckProps) => {
    ...
    const { selectedTruck, saveTruck, truckLoading, getIndividualtruck } = useTruckContext();
    ...
    console.log("editTruckDetail", editTruckDetail);
    ...
    useEffect(() => {
        if (!truckLoading && selectedTruck && truck_id > 0) {
