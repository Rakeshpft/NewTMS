...
const TrailerDetails = (prop: ITrailerProps) => {
    ...
    useEffect(()=>{
        if(stateList && stateList.length>0 && (editTrailerDetail.plate_state_id==0 || editTrailerDetail.lease_state_id==0)){            
            setEditTrailerDetail({
                ...editTrailerDetail,
                plate_state_id: (editTrailerDetail.plate_state_id==0?stateList[0].state_id:editTrailerDetail.plate_state_id),
                lease_state_id: (editTrailerDetail.lease_state_id==0?stateList[0].state_id:editTrailerDetail.lease_state_id),
            })
        }
    },[stateList])
    useEffect(()=>{
        if(trailerTypeList && trailerTypeList.length>0 && editTrailerDetail.trailer_type_id==0){
            setEditTrailerDetail({
                ...editTrailerDetail,
                trailer_type_id: trailerTypeList[0].trailer_type_id,
            })
        }
    },[trailerTypeList])
    useEffect(()=>{
        if(ownershipTypeList && ownershipTypeList.length>0 && editTrailerDetail.ownership_type_id==0){
            setEditTrailerDetail({
                ...editTrailerDetail,
    ...
    useEffect(()=>{
        if(driverList && driverList.length>0 && editTrailerDetail.driver_id==0){
            setEditTrailerDetail({
                ...editTrailerDetail,
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="unit" name="unit"
                                        value={editTrailerDetail.unit} onChange={handleInputChange("unit")} required >
                                    </Input>
                                </FormGroup>
                            </Col>
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="select" id="trailer_type_id" name="trailer_type_id"
                                        value={editTrailerDetail.trailer_type_id} onChange={handleInputChange("trailer_type_id")} required>
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="vin_number" name="vin_number"
                                        value={editTrailerDetail.vin_number} onChange={handleInputChange("vin_number")} required/>
                                </FormGroup>
                            </Col>
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="select" id="driver_id" name="driver_id"
                                        value={editTrailerDetail.driver_id} onChange={handleInputChange("driver_id")} required>
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="year" name="year"
                                        value={editTrailerDetail.year} onChange={handleInputChange("year")} required />
                                </FormGroup>
                            </Col>
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="make" name="make"
                                        value={editTrailerDetail.make} onChange={handleInputChange("make")}required />
                                </FormGroup>
                            </Col>
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="model" name="model"
                                        value={editTrailerDetail.model} onChange={handleInputChange("model")}required />
                                </FormGroup>
                            </Col>
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="plate_number" name="plate_number"
                                        value={editTrailerDetail.plate_number} onChange={handleInputChange("plate_number")} required/>
                                </FormGroup>
                            </Col>
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="select" id="plate_state_id" name="plate_state_id"
                                        value={editTrailerDetail.plate_state_id} onChange={handleInputChange("plate_state_id")} required>
                            ...
                            <Col md={3}>
                                <FormGroup>
                                    ...
                                    <Input bsSize="sm" className="form-control" type="text" id="description" name="description"
                                        value={editTrailerDetail.description} onChange={handleInputChange("description")} required/>
                                </FormGroup>
                            </Col>
